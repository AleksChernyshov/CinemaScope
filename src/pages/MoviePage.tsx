          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="flex flex-col md:flex-row gap-8 -mt-32">
              <div className="shrink-0 md:w-64 relative">
                ...
                <button
                  onClick={() => navigate(-1)}
                  className="cinema-button absolute -top-24 left-0 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-full 
                ...
                >
                  ...
                  <span className="inline-block leading-none translate-y-[1px]">{t('movie.back')}</span>
                </button>
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  >
                    {isAuthenticated && isFavorited ? (
                      ...
                      <svg 
                        className="w-8 h-8 text-white group-hover/fav:text-purple-500 transition-colors duration-300"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth={2}
                        viewBox="0 0 24 24"
