...
const INFO_STYLES = {
  ...
  stats: "flex items-center gap-3 text-sm",
  rating: "flex items-center gap-1.5",
  ratingValue: "text-purple-400 font-medium",
  separator: "text-text-secondary/70",
  votes: "text-text-secondary/70"
};
      ...
      <div className={INFO_STYLES.content}>
        ...
        <div className={INFO_STYLES.stats}>
          <div className={INFO_STYLES.rating}>
            ...
            <span className={INFO_STYLES.ratingValue}>
              {rating}
            </span>
          </div>
          {voteCount > 0 && (
