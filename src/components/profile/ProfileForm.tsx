...
// Styling constants
const STYLES = {
  container: "mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 mt-6",
  form: "mt-6 bg-bg-secondary shadow-lg shadow-purple-500/10 rounded-xl backdrop-blur-xl ring-1 ring-purple-500/30 transition-shadow duration-300 hover:shadow-purple-500/20",
  ...
  input: (readonly: boolean) => `nav-text block w-full rounded-md border-0 px-4 font-semibold text-text-primary bg-bg-primary shadow-sm ring-1 ring-inset ring-purple-500/30 transition-all duration-200 leading-none h-9 outline-none ${
    readonly 
